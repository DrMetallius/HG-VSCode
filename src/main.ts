...
async function init(context: ExtensionContext, disposables: Disposable[]): Promise<void> { //TODO: add opening files on click, asking about untracked on commit, partial commit, status bar, pull, push, revert, branch switching
